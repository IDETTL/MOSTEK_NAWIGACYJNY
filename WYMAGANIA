...
	Wydajności:
o	Generowanie obrazu wysokiej rozdzielczości dla dowolnego układu monitorów bezbramkowych, płynny obraz na poziomie 60 klatek/s bez spadku większego niż 10 kl/s przy dynamicznej sytuacji taktycznej.
o	Rozruch systemu nie powinien przekraczać 10 minut 

	Bezpieczeństwa:
o	System symulatora powinien być odizolowany od sieci Internet, aktualizacja odbywać się będzie przez fizyczne podpięcie się technika. Porty USB i CD/DVD zablokowane na wszystkich urządzeniach laboratoryjnych z wyłączeniem stanowiska instruktora. 
o	Sprawdzenie kompatybilności i integralności systemu symulatora po każdej aktualizacji i lub na żądanie klienta 
